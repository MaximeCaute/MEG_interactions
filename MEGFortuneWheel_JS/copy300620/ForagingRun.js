...
var infoSheet = new TimeLine(["participantInfoSheet", "exitNow"], ["landingPageDiv","goBackButton", "consentForm", "returnToInfoPage", "TaskInstrReminder"], [checkBoxes], "infoSheet");
var consent = new TimeLine(["returnToInfoPage", "consentForm", "exitNow"],["participantInfoSheet"], [checkBoxes], "consent");

var   subjectInfo_Internet = new TimeLine(["surveyContainer", "exitNow"], ["consentForm","startExperiment", "next-button"], [introQuestions_Internet, runQuestionnaires], "subjectInfo");
...
var forageInstructions = new TimeLine(["exitNow", "instructionsDiv"],["consentDiv","quizDiv", "surveyContainer"],[setupInstructions,showInstructions],"Instr"),
    forageTraining= new TimeLine(["exitNow", "forageDiv"],["consentDiv","instructionsDiv"],[setupTraining,runForagingTask],"Training"),
    testUnderstanding= new TimeLine(["exitNow", "quizDiv"],["forageDiv","consentDiv","instructionsDiv","landingPageDiv"],[setupMCQ,runMCQ],"MCQ"),
    forageGame = new TimeLine(["exitNow", "forageDiv"], ["consentDiv","instructionsDiv","quizDiv","landingPageDiv"], [setupForagingTask, runForagingTask],"Task");
