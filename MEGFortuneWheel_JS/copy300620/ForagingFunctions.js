// name of the study path inside the jatos folder - stored here so that if we change it, we don't have to retype all the names
// (we are defining this here because Foraging Functions is the one script that is loaded via html)
...
function loadSchedules(){
  // Schedule for training
    ...
    if (settings.datatype=="Internet"){
      ...
      //data.schedID=Math.ceil(Math.random() * Math.floor(5))
      //data.schedID=jatos.batchSession.get("thisCondition")
      data.schedID=jatos.studySessionData.thisCondition
...
function quitStudy() {
  ...
  if (settings.datatype=="Internet"){
    ...
    $("#finishExptButton").html('Your data is submitted. Please notify the experimenter that you are finished.');
...
function finishMCQ(){
    ...
    if (corAnsSum === settings.mcq.maxQ){ // if all correct, say thank you and, move on to task
        ...
        $('#quizTextDiv').html(["<br><br>You have completed the training successfully.<br><br>",
            MCQs[0].question,"<span style='color: #029F73'> Your answer: ", tSet.mcq.answers[0], " - ", MCQs[0].answers[tSet.mcq.answers[0]].slice(0,-4), " (CORRECT)</span><br>",
            MCQs[1].question,"<span style='color: #029F73'> Your answer: ", tSet.mcq.answers[1], " - ", MCQs[1].answers[tSet.mcq.answers[1]].slice(0,-4), " (CORRECT)</span><br>", //D36027 for red
            MCQs[2].question,"<span style='color: #029F73'> Your answer: ", tSet.mcq.answers[2], " - ", MCQs[2].answers[tSet.mcq.answers[2]], " (CORRECT)</span><br>",
            MCQs[3].question,"<span style='color: #029F73'> Your answer: ", tSet.mcq.answers[3], " - ", MCQs[3].answers[tSet.mcq.answers[3]], " (CORRECT)</span><br>",
            MCQs[4].question,"<span style='color: #029F73'> Your answer: ", tSet.mcq.answers[4], " - ", MCQs[4].answers[tSet.mcq.answers[4]], " (CORRECT)</span><br>",
            MCQs[5].question,"<span style='color: #029F73'> Your answer: ", tSet.mcq.answers[5], " - ", MCQs[5].answers[tSet.mcq.answers[5]], " (CORRECT)</span><br>",
        ].join(''));  //$('#quizPicDiv'
        ...
        $('#finishMCQButton').prop('disabled',true);
        $('#lastMCQButton').prop('disabled',true);
        $('#startTrainingButton').html('Retry quiz');
        $('#quizTextDiv').css({ top: '0%' });
        ...
        $('#quizTextDiv').html(["<br><br>Unfortunately you have not answered all the questions correctly. Please read through the instructions and try again.<br><br>",
              MCQs[0].question,"<br><span style='color: #",(tSet.mcq.answers[0]===MCQs[0].correctAnswer)?"029F73":"D36027","'> Your answer: ",
              ...
              MCQs[1].question,"<br><span style='color: #",(tSet.mcq.answers[1]===MCQs[1].correctAnswer)?"029F73":"D36027","'> Your answer: ",
              ...
              MCQs[2].question,"<br><span style='color: #",(tSet.mcq.answers[2]===MCQs[2].correctAnswer)?"029F73":"D36027","'> Your answer: ",
              ...
              MCQs[3].question,"<br><span style='color: #",(tSet.mcq.answers[3]===MCQs[3].correctAnswer)?"029F73":"D36027","'> Your answer: ",
              ...
              MCQs[4].question,"<br><span style='color: #",(tSet.mcq.answers[4]===MCQs[4].correctAnswer)?"029F73":"D36027","'> Your answer: ",
              ...
              MCQs[5].question,"<br><span style='color: #",(tSet.mcq.answers[5]===MCQs[5].correctAnswer)?"029F73":"D36027","'> Your answer: ",
