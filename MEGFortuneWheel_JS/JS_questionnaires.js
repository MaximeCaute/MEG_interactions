...
function WOFdebriefQuestionnaire(){
  surveyType=1
  surveyJSON={pages: [ { name: "page1", elements: [ { type: "matrix", name: "DebriefQs", title: "Maintenant, voici quelques questions sur votre expérience de jeu. A quelle fréquence avez vous expérimenté les propositions suivantes ?", columns: [ { value: "0", text: "0 - Jamais" }, { value: "1", text: "1 " }, "2", { value: "3", text: "3 " }, "4", "5", { value: "6", text: "6 - Tout le temps" } ], rows: [ { value: "Q1", text: "Q1. J'ai fait tourner la roue trop de fois dans une manche car je souhaitais obtenir un score particulier de la roue" }, { value: "Q2", text: "Q2. J'ai continué de faire tourner la roue parce que je l'avais déjà faite tourner sur cette manche plutôt que parce que c'était le bon choix" }, { value: "Q3", text: "Q3. J'ai fait tourner la roue trop de fois durant une marche, sans prendre en compte son coût trop important" }, { value: "Q4", text: "Q4. J'ai évité de commencer à faire tourner la roue par crainte de la relancer trop de fois" } ] } ] } ] }
  tSet.questionnaire.minTime=000; // in msec
}
...
if (!isBlank & !timeIssue) { //Case 1: there's no time issue, they just forgot some questions
  ...
  + "<button type=\"button\" id=\"confirmButton2\"  class=\"allButtons\" style=\"margin:auto;\" onclick=\"closeDialog_continue();\">Poursuivre sans répondre</button><br><br>";
} else if (isBlank) { //Case 2: Regardless of time, they submitted a blank questionnaire
  document.getElementById("dialog-confirm").innerHTML = "<br><br><br>Le questionnaire est incomplet. Voulez-vous poursuivre l'expérience?<br><br>"
  + "<button type=\"button\" id=\"confirmButton1\"  class=\"allButtons\" style=\"margin:auto;\" onclick=\"closeDialog_return();\">Retourner au questionnaire</button><br><br>"
  + "<button type=\"button\" id=\"confirmButton2\"  class=\"allButtons\" style=\"margin:auto;\" onclick=\"closeDialog_continue();\">Poursuivre sans répondre</button><br><br>";
